...
| [docs/decisions.md](docs/decisions.md) | 技術決策紀錄（D1–D17） |
...
同機器開 <http://127.0.0.1:53346/>；外部則開 `http://<Oracle 公網 IP>:53346/`。完整的 seed 14 五分鐘循環、2→3→4 maps、Save/Load/Rewind 與回報格式見 [docs/playtest.md](docs/playtest.md)。
